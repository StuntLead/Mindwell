...
void printMonthCalendar(int month, int year) {
    ...
    int k = year % 100;
    int j = year / 100;
    int f = k + k/4 + 5*j + j/4 + 13*(month+1)/5 - 1;
    int dayOfWeek = f % 7;
...
do{
   ...
   do{
    ...
    printf("Platform: %s\n", temp.app);
    if (appxuan==1){
        printf("Zoom link: https://zoom.us/j/1234567890\n");
    }
    else if (appxuan==2){
        printf("Google Meet link: https://meet.google.com/abc-defg-hij\n");
    }
    ...
    switch (choice) {
        ...
        case 1:{
            ...
            switch(xuan){
                case 1: {
                    ...
                    printf(CYN); printf("https://wa.me/6281234567890\n");  printf(reset);
                    printf(YEL); printf("\nPress enter to continue..."); getchar(); getchar();
                    break;
                }
                case 2:{
                    printf(MAG); printf("\n\nPlease kindly click the link below to chat with Dr. Jesslyn\n"); printf(reset);
                    printf(CYN); printf("https://line.me/ti/p/~drjesslyn\n"); 
                    printf(YEL); printf("\nPress enter to continue..."); getchar(); getchar();
                    break;
                }
                case 3:{
                    printf(MAG); printf("\n\nPlease kindly click the link below to chat with Dr. Jesslyn\n"); printf(reset);
                    printf(CYN); printf("https://t.me/drjesslyn\n");
                    printf(YEL); printf("\nPress enter to continue..."); getchar(); getchar();
                    break;
                }
                default: {
        ...
        case 2:{
            ...
            switch(xuan){
                ...
                case 2:{
                    printf(MAG); printf("\n\nPlease kindly click the link below to chat with Dr. Nando\n"); printf(reset);
                    printf(CYN); printf("https://line.me/ti/p/~drnando\n"); 
                    printf(YEL); printf("\nPress enter to continue..."); getchar(); getchar();
                    break;
                }
                case 3:{
                    printf(MAG); printf("\n\nPlease kindly click the link below to chat with Dr. Nando\n"); printf(reset);
                    printf(CYN); printf("https://t.me/drnando\n");
                    printf(YEL); printf("\nPress enter to continue..."); getchar(); getchar();
                    break;
                }
                default: {
        ...
        case 3:{
            ...
            switch(xuan){
                ...
                case 2:{
                    printf(MAG); printf("\n\nPlease kindly click the link below to chat with Dr. Bintang\n"); printf(reset);
                    printf(CYN); printf("https://line.me/ti/p/~drbintang\n"); 
                    printf(YEL); printf("\nPress enter to continue..."); getchar(); getchar();
                    break;
                }
                case 3:{
                    printf(MAG); printf("\n\nPlease kindly click the link below to chat with Dr. Bintang\n"); printf(reset);
                    printf(CYN); printf("https://t.me/drbintang\n");
                    printf(YEL); printf("\nPress enter to continue..."); getchar(); getchar();
                    break;
                }
                default: {
